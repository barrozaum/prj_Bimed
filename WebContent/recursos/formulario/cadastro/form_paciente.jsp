<jsp:useBean id="mb_convenio" class="manager.ManagerConvenio"></jsp:useBean>
...
<div
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="panel-title">Cadastro Paciente</div>
		</div>

		<div class="panel-body">
			<form action="ControlePaciente" method="post" id="form_cadastro">
				...
				<div style="overflow: auto; max-width: 100%; max-height: 250px;">
					<table class="table table-hover table-striped">
						...
						<tbody>
							<c:forEach items="${mb_convenio.listar_convenio}" var="linha">
								<tr>
									<th>${linha.descricaoConvenio}</th>
									<th><input type="checkbox" name="convenios_paciente[]"
										value="${linha.idConvenio}" /></th>
								</tr>
							</c:forEach>
						</tbody>
					</table>
