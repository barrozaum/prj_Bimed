<jsp:useBean id="mb_especialidade" class="manager.ManagerEspecialidade"></jsp:useBean>
...
<div
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<div class="panel-title">Cadastro Medico</div>
		</div>

		<div class="panel-body">
			<form action="ControleMedico" method="post" id="form_cadastro">
					...
					<div class="col-sm-6 col-sm-offset-0">
						<div class='form-group'>
							<label for="crm">CRM:</label> <input type="text"
								title="informe o crm " name="crm" id="crm" value=""
								maxlength="50" class="form-control" />
						</div>
					</div>
				</div>
					...
					<div class="col-sm-2 col-sm-offset-0">
						<div class='form-group'>
							<label for="numero_end">Número:</label> <input type="text"
								title="informe o numero_end" name="numeroEndereco" id="numeroEndereco"
								value="" maxlength="50" class="form-control" />
						</div>
					</div>
				...
				<hr />
				<div style="overflow: auto; max-width: 100%; max-height: 250px;">
					<table class="table table-hover table-striped">
						...
						<tbody>
							<c:forEach items="${mb_especialidade.lista_especialidade}"
								var="linha">
								<tr>
									<th>${linha.descricaoEspecialidade}</th>
									<th><input type="checkbox" name="especialidade_medica[]"
										value="${linha.idEspecialidade}" /></th>
								</tr>
							</c:forEach>
						</tbody>
					</table>
